...
describe('Service: InfoFormService', () => {
  let service: InfoFormService = null;
  ...
  beforeEach(inject([InfoFormService, MockBackend], (infoFormService: InfoFormService, mockBackend: MockBackend) => {
